...
},
{
  ...
  longHeading: "Fashion is a global industry that involves the creation and mixing of clothing, footwear, accessories, cosmetics, and jewelry. It's a significant part of the global economy, and if it were ranked as a country's GDP, it would be the world's seventh-largest economy.",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-sm:gap-8">
          {posts.map((post) => (
            <div key={post.id} className="bg-white rounded overflow-hidden">
              <Image      className="w-full h-52 object-cover"    width={200}      height={200}   src={post.image}
                alt={post.smallHeading} />
