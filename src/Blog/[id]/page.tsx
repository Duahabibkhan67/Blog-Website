...
const blogPosts: Record<
  number,
  { smallHeading: string;  longHeading:string; description: string; image?: string  }
> = {
    1:{
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto text-center bg-slate-100">
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden mx-auto font-sans mt-6">
        <div className="p-6">
          <h3 className="text-gray-900 text-2xl font-bold mb-4 hover:text-blue-950 hover:underline transition-colors duration-200">
            {post.smallHeading}
          </h3>
          {post.image && (
            <Image 
              src={post.image}
              alt={post.longHeading}
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden mx-auto p-6 mt-8 max-w-3xl">
        ...
        <div className="mt-6">
          <input
            ...
            className="border border-gray-300 p-2 rounded w-full mb-3 focus:ring-2 focus:ring-blue-900"
          />
          <textarea
            value={newComment}
            onChange={(e) => setNewComment(e.target.value)}
            placeholder="Write your comment..."
            className="border border-gray-300 p-2 rounded w-full mb-3 h-20 focus:ring-2 focus:ring-blue-900"
          ></textarea>
          <button
            onClick={addComment}
            className="bg-blue-800 text-white px-4 py-2 rounded hover:bg-blue-950 w-full"
          >
            Add Comment
          </button>
        </div>
